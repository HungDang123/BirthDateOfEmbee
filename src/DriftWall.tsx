...
const DEFAULT_ITEMS: DriftItem[] = Array.from({ length: 15 }, (_, i) => {
...
const DriftWall = ({
  ...
  const columnItems = useMemo<DriftItem[][]>(() => {
  ...
  const renderTile = (item: DriftItem, id: string, colIndex: number): ReactNode => {
    const inner = (
